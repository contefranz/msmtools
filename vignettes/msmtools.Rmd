...
**msm** [@jackson2011multi; @msm_cran]. The package is built around four public
functions:
...
time. The bundled data do not contain such conflicts, so this call leaves the row
data unchanged.
...
The fitted and Kaplan-Meier data used by the plot are also available.
