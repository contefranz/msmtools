...
<!-- survplot( x = msm_model, from = 1 ) -->

<!-- # plotting the first survival from state 'OUT' -->
<!-- survplot( x = msm_model, from = 2 ) -->
<!-- ``` -->
...
prevplot( x = msm_model, prev, ci = TRUE, devnew = FALSE, verbose = FALSE )
```
...
prevplot( x = msm_model, prev, M = TRUE, ci = TRUE, 
