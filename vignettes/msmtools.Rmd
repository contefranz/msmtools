...
When `km` is set to `TRUE`, `survplot()` computes the associated dataset real fast using `data.table`.
It is possible to tell `survplot()` to return this by setting `return.km = TRUE`. 
