...
`return.km = TRUE` by fastly computing the data using `data.table`. Passing only `km = TRUE` won't
return any data, even if they must be computed anyway.
...
Consider our dataset and suppose we want to compute a fitted survival at for the second year from 
now. The following code addresses this request.
